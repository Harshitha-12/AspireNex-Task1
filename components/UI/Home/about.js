            ...
            <div className="z-50 flex flex-col-reverse items-center grid-cols-2 gap-16 md:grid">
              <TransitionReveal addClass="space-y-8">
                <p className="text-lg leading-loose text-primary/80">
                  <span className="text-4xl font-semibold leading-normal">Hi!</span> I&lsquo;m Harshitha, I am a dedicated IT student with a strong passion for technology. My technical strengths encompass Data Structures and Algorithms (DSA),
                   Java programming, and MERN Stack for full-stack web development. I am committed to expanding my
                   knowledge and skills in these areas to contribute meaningfully to the ever-evolving field of information technology.
                </p>

                <div className="w-fit">
                  <a download={true} href={"/docs/Manukonda_Harshitha_Resume.pdf"}>
                    <button className="flex items-center gap-2 px-4 py-2 transition-colors duration-300 bg-transparent border rounded-md hover:bg-primary hover:text-primaryBlack-100 border-primary text-primary">
                      <span>Download My Resume</span> <DownloadIcon />
                    </button>
                  </a>
                </div>
              </TransitionReveal>
